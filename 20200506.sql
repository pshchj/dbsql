...
1. 테이블의 모든 컬럼에 값을 입력하는 경우, 컬럼명을 나열하지 않아도 된다
   단 입력할 값의 순서는 테이블의 정의된 컬럼 순서로 인식된다
...
empno가 9999이고 ename은 본인이름, hiredate는 현재 일시를 저장하는 INSERT

INSERT INTO emp (empno, ename, hiredate) VALUES(9999, 'park', SYSDATE );

9999번 사번으로 jw 사원을 입력, 입사일자는 2020년 4월 13일로 설정하여 데이터 입력
INSERT INTO emp (empno, ename, hiredate) VALUES(9998, 'jw', '20200413' );
...
ROLLBACK; --롤백해도 복구되지 않는다.

트랜잭션 : 논리적인 일의 단위
ex : ATM- 출금과 입금이 둘 다 정상적으로 이루어져야 문제가 발생되지 않음
...
INSERT INTO 게시글 첨부파일 테이블 (첨부파일명, 첨부파일) VALUES (......);          
